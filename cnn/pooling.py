...
class MaxPool:
    ...
    def backward(self, dL_dout): 
        ...
        b_index = np.arange(self.input.shape[0])[:, None, None, None]
        h_index = np.arange(self.out_dim[0])[None, :, None, None] 
        w_index = np.arange(self.out_dim[1])[None, None, :, None] 
        c_index = np.arange(self.out_dim[2])[None, None, None, :] 
        ...
        out[b_index, h_index, w_index, c_index] = dL_dout
